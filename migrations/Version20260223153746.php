 ...
 */
final class Version20260223153746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE6796D554 FOREIGN KEY (merchant_id) REFERENCES merchants (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP FOREIGN KEY FK_E52FFDEE6796D554');
